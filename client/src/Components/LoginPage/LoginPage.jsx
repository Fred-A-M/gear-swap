...
export default function LoginPage ({changeState}) {
  ...
  return (
    ...
    <div className='flex justify-center items-center h-lvh'>
      <div className='min-h-custom-min w-96 bg-boxes rounded-2xl flex flex-col items-center transition duration-300'>
        <div>
          <img className='h-56 mt-5' src="/src/assets/logo2.png" alt="" />
        </div>
        <div>
