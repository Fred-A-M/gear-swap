...
export default function GearList ({selectedProfile, addToUsersWishList}) {
  ...
  return (
    <>
     <div className='user-gear-list w-4/5 min-w-80 transition duration-300 bg-profiles1 hover:bg-profiles2 rounded-2xl mb-8 drop-shadow-2xl p-6 max-h-custom-max overflow-y-scroll '>
